import { getActiveListingPagingPage, getListingsPerPage, getListingsAmount, getSessionIdCookie } from './utils';
...
export function removeItemListing(listingId : string, checkboxElement : HTMLInputElement) {
...
export function getMarketListings(start, count) {
    if(start === undefined) {
        start = 0;
    };
